...
const (
	RestrictionTypeNone        = "none"
	RestrictionTypeHttpReferer = "http_referer"
	RestrictionTypeIpAddress   = "ip_address"
)

var RestrictionTypes = []string{
	RestrictionTypeNone,
	RestrictionTypeHttpReferer,
	RestrictionTypeIpAddress,
}
...
type ApiKey struct {
	...
	Restriction   *ApiKeyRestriction `json:"restriction,omitempty" bson:"restriction,omitempty"`
